...
"")
        ...
        self.qtable_avoids.setMinimumSize(QtCore.QSize(400, 0))
        ...
        self.label_3 = QtWidgets.QLabel(self.avoids_tab)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_8.addWidget(self.label_3, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout_8.addWidget(self.btn_save_avoids, 0, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        self.btn_clear_avoids = QtWidgets.QPushButton(self.avoids_tab)
        self.btn_clear_avoids.setMaximumSize(QtCore.QSize(300, 16777215))
        self.btn_clear_avoids.setObjectName("btn_clear_avoids")
        self.gridLayout_8.addWidget(self.btn_clear_avoids, 0, 1, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.line_5 = QtWidgets.QFrame(self.avoids_tab)
        self.line_5.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.horizontalLayout_9.addWidget(self.line_5)
        self.text_internal_names = QtWidgets.QPlainTextEdit(self.avoids_tab)
        self.text_internal_names.setObjectName("text_internal_names")
        self.horizontalLayout_9.addWidget(self.text_internal_names)
    ...
    def retranslateUi(self, NameEvaluator):
        ...
        self.label_project_avoids.setText(_translate("NameEvaluator", "Project Avoids"))
        self.label_3.setText(_translate("NameEvaluator", "Internal Names"))
        self.label_competitor.setText(_translate("NameEvaluator", "Competitors"))
        ...
        self.btn_clear_avoids.setStatusTip(_translate("NameEvaluator", "Clear and reset avoids"))
        self.btn_clear_avoids.setText(_translate("NameEvaluator", "Clear Avoids"))
        self.text_project_avoids.setStatusTip(_translate("NameEvaluator", "Enter project avoids here"))
        self.text_project_avoids.setPlaceholderText(_translate("NameEvaluator", "some instructions here...."))
        self.text_internal_names.setPlaceholderText(_translate("NameEvaluator", "some instructions here...."))
        self.text_competitor.setStatusTip(_translate("NameEvaluator", "Enter competitor names here"))
        self.text_competitor.setPlaceholderText(_translate("NameEvaluator", "some instructions here...."))
