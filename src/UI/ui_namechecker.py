...
"")
        ...
        self.qtable_results.setSortingEnabled(True)
...
"")
    ...
    def retranslateUi(self, NameEvaluator):
        ...
        self.checkbox_linguistic.setStatusTip(_translate("NameEvaluator", "Check against linguistic avoids"))
        ...
        self.btn_check_names.setStatusTip(_translate("NameEvaluator", "Commit and run names against all selected avoids [Ctrl+ Enter]"))
        ...
        self.btn_exit.setStatusTip(_translate("NameEvaluator", "Exit the application"))
        ...
        self.qtable_avoids.setStatusTip(_translate("NameEvaluator", "Complete list of all avoids"))
        self.btn_reload_avoids.setStatusTip(_translate("NameEvaluator", "Reload avoids from master list only"))
        self.btn_reload_avoids.setText(_translate("NameEvaluator", "Reload Avoids"))
        self.btn_filter_avoids.setStatusTip(_translate("NameEvaluator", "Activate specified filter"))
        self.btn_filter_avoids.setText(_translate("NameEvaluator", "Search"))
        self.lineedit_filter_avoids.setStatusTip(_translate("NameEvaluator", "Enter avoids to filter for here"))
        self.lineedit_filter_avoids.setPlaceholderText(_translate("NameEvaluator", "Filter avoids"))
        self.btn_clear_avoid_filter.setStatusTip(_translate("NameEvaluator", "Clear specified filter"))
        ...
        self.btn_save_avoids.setStatusTip(_translate("NameEvaluator", "Save and combine avoids with master list [Ctrl+Enter]"))
        self.btn_save_avoids.setText(_translate("NameEvaluator", "Save Avoids"))
        self.btn_save_avoids.setShortcut(_translate("NameEvaluator", "Ctrl+Return"))
        self.text_project_avoids.setStatusTip(_translate("NameEvaluator", "Enter project avoids here"))
        self.text_competitor.setStatusTip(_translate("NameEvaluator", "Enter competitor names here"))
